...
| Python/projects/bike_sharing/bike.ipynb | Previous output showed a model feature-shape mismatch | Fixing it could change analytical method/conclusions | Diagnose and correct in a separate analytical task; mark partial; archive | Treat as a future project-specific fix, not repository curation |
